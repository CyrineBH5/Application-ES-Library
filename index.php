...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.php"><i class="bi bi-book"></i> ES-Library</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="login.php" style="background-color:crimson;padding: 10px;border-radius: 25px;  font-size:11px"><i class="bi bi-person-square"></i>&nbsp; &nbsp;Sign In</a></li>
  ...
  <section id="hero">
    <div class="hero-container">
      <h2 style="color:lightgoldenrodyellow;font-family:Verdana, Geneva, Tahoma, sans-serif ;font-size: 170%;font-weight: 400;"><b>Unlock your imagination: <br>Reserve your books Now!</b>
      </h2>
      <!--  search ... -->
              ...
              <div class="member">
                <div class="member-img">
                  ...
                  <div class="social">
                    ...
                    <a href="assets/img/<?= $row['Image'] ?>" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="<?= "Title : " . $row['titre'] . "</br> Author :" . $row['auteur'] . "</br> Edition : " . $row['date_edition'] ?>"><i style="font-size: small;" class="bi bi-arrows-angle-expand"></i></a>
                    <a href="portfolio-details.php?idi=<?php echo ($row['id']);  ?>" class="details-link" title="More Details"><i class="bx bx-plus"></i></a>
                  </div>
                </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p style="font-size:20px; font-weight:100; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif"> Welcome to our library, where knowledge meets imagination.<br> Discover a vast collection of books, engaging programs, and a welcoming community. Embrace the joy of reading, explore digital resources, and embark on endless literary adventures. Join us on a journey of discovery and lifelong learning.
          </p>
        </div>
      </div>
    </section>
