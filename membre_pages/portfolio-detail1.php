...
if (!isset($_SESSION['user_id'])) {
  header("location:portfolio-detail.php");
  exit;
}
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="profile.php"><i class="bi bi-person-square"></i>&nbsp; &nbsp; Profile</a></li>
          <li><a class="nav-link scrollto" href="../logout.php"> <i class="bi bi-box-arrow-right"></i>&nbsp; Logout</a></li>
        </ul>
        ...
        <div class="container">
          ...
          <div class="row gy-4">
            ...
            <div class="col-lg-4">
              <div class="portfolio-info">
                ...
                <ul>
                  ...
                  <li><strong>Edition Date</strong> : <?= $app[0]['date_edition'] ?></li>
                  <li><strong>N° availability</strong> : <?= $app[0]['nb_dispo'] ?></li>
                  <br>
                  <a href="reserve.php?idi=<?= $app[0]['id'] ?>" id="reserveLink">
                    <button disabled type="button" style="margin-left:61%" id="btnreserve" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-xxs px-4 py-2 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
            ...
            <script>
              ...
              var boutonReserver = document.getElementById('btnreserve');
              var qte = <?= $app[0]['nb_dispo'] ?>;

              function verifierDisponibilite() {
                if (qte > 0) {
                  boutonReserver.disabled = false; // Rendre le bouton cliquable
                } else {
                  boutonReserver.disabled = true; // Rendre le bouton non cliquable
