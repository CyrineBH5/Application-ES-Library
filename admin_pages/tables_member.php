                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold " style="color:darkblue;"><i class="bi bi-view-list"></i> LIST MEMBERS</h6>
                        </div>
                        <div class="card-body">
                            <div class="table">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        $admin = new fn_admin();
                                        $rows = $admin->findAllMembre();
                                        //var_dump($rows);
                                        foreach ($rows as $row) {

                                        ?>
                                            <tr>
                                                <td><img src="../assets/img/<?= $row['Image'] ?> " class="img-fluid image-petite" style="width:40%"></td>
                                                <td><?php echo $row['nom']; ?></td>
                                                <td><?php echo $row['prenom']; ?></td>
                                                <td><?php $date = $row['date_naissance'];
                            ...
                            <a href="delete_membre.php?delid=<?php echo ($row['id']);  ?>" style="font-size:12px; margin-left:38%;" data-toggle="modal" data-target="#logoutModal"><img src="../images/delete.png" alt="" srcset=""></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger" href="delete_membre.php?delid=<?php echo ($row['id']);  ?>">Delete</a>
                </div>
            </div>
        </div>
    </div>
